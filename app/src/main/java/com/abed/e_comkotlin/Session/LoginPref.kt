package com.abed.e_comkotlin.Session

import android.content.Context
import android.content.Intent
import android.content.SharedPreferences
import com.abed.e_comkotlin.Activity.createAccountScreen
import com.abed.e_comkotlin.Activity.login_screen
...
class LoginPref {
    ...
    fun checkLogin() {
        if (!this.isLoggedIn()) {
            var i: Intent = Intent(con, LoginPref::class.java)
